...
function ExercisePicker({ sessionId, orderIndex }: { sessionId: string; orderIndex: number }) {
  ...
  // After a custom exercise is created via the inline form, immediately add
  // it to the current workout — that's what the user wanted when they hit
  // "+ Create custom" mid-search.
